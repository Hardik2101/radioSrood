...
class AppOpenAdManager: NSObject {
  ...
  func loadAd() {
    ...
    GADAppOpenAd.load(
        withAdUnitID: IAPHandler.shared.isGetPurchase()  ? "" : "ca-app-pub-7049872613588191/9284617638",
      request: GADRequest(),
      ...
      if let error = error {
        self.appOpenAd = nil
        self.loadTime = nil
          self.appOpenAdManagerDelegate?.failedToLoadAd()
